      ...
      try {
        ...
        if (result.success) {
          if (result.saved) {
            ...
            console.log("📝 Newsletter signup received (database not configured)");
            console.log("💡 Tip: Add Supabase credentials to Vercel to enable database storage");
          }
        } else {
          console.warn("⚠️ Newsletter submission issue:", result.error);
        }

        // Show success message (always show to user)
